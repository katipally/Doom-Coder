// SettingsView.swift — Doom Coder Companion
...
struct SettingsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("This clears the paired Mac and the cached agent data on this device. Your iCloud data and the Doom Coder Mac app are not affected. You can reconnect any time.")
        }
        .task {
    ...
    private var connectionSection: some View {
        Section {
            ...
            if macStore.primary != nil {
                ...
                Text("Connect to the Doom Coder Mac app to see live agent status and control keep-awake remotely. The app is fully usable without a Mac.")
            }
        }
    }
