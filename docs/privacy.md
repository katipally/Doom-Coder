# Doom Coder Companion Privacy Policy
...
Doom Coder Companion does not collect, store, or share any personal data with its developer or any third party. All synchronisation happens privately through your own iCloud account using Apple CloudKit, which you already control.

---

## 1. Who we are

Doom Coder is built and maintained by an independent developer. There are no backend servers, analytics infrastructure, or accounts operated by us. The app is a client-only tool that uses Apple's own frameworks and, optionally, AI providers that you configure with your own credentials.
...
If you pair the iOS app with the Doom Coder Mac app, the following data is synced **solely between your own devices** via your private iCloud account (Apple CloudKit):
...
| **Notifications** | Deliver note reminders you set, and (when a Mac is paired) real-time agent alerts from Doom Coder on your Mac. |
...
**iCloud data:** To delete CloudKit data, sign in to [icloud.com](https://www.icloud.com/) → Settings → Manage Storage → Doom Coder → Delete. Alternatively, disabling iCloud Drive for the app in your device's Settings will stop sync and remove the local cache.
