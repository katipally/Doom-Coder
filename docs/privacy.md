...
Doom Code Companion does not collect, store, or share any personal data with its developer or any third party. All synchronisation happens privately through your own iCloud account using Apple CloudKit, which you already control.

---

## 1. Who we are

Doom Code is built and maintained by an independent developer. There are no backend servers, analytics infrastructure, or accounts operated by us. The app is a client-only tool that uses Apple's own frameworks and, optionally, AI providers that you configure with your own credentials.
...
If you pair the iOS app with the Doom Code Mac app, the following data is synced **solely between your own devices** via your private iCloud account (Apple CloudKit):
...
**iCloud data:** To delete CloudKit data, sign in to [icloud.com](https://www.icloud.com/) → Settings → Manage Storage → Doom Code → Delete. Alternatively, disabling iCloud Drive for the app in your device's Settings will stop sync and remove the local cache.
...
Questions about this policy? Open an issue at [github.com/katipally/Doom-Code](https://github.com/katipally/Doom-Code) or email via the contact information on the App Store listing.
