...
final class NotificationDispatcher {
    ...
    private func readableEventLabel(_ rawEvent: String) -> String {
        ...
        case "afterAgentResponse":     return "agent replied"
        case "beforeShellExecution":   return "running shell"
        case "afterShellExecution":    return "shell done"
        case "beforeMCPExecution":     return "calling MCP"
        case "afterMCPExecution":      return "MCP done"
        case "afterFileEdit":          return "file edited"
        case "beforeReadFile":         return "reading file"
        case "sessionStart",
             "SessionStart":           return "session started"
        case "sessionEnd",
             "SessionEnd":             return "session ended"
        case "subagentStart":          return "sub-agent started"
        case "subagentStop":           return "sub-agent done"
        // Claude
        ...
        case "StopFailure":           return "session crashed"
        case "PermissionRequest":     return "needs permission"
