// MacReachabilityBanner.swift — Doom Coder Companion
...
struct MacReachabilityBanner: View {
    ...
    private func banner(for mac: MacStatusRecord, level: Level, now: Date) -> some View {
        ...
        let detail = (level == .offline)
            ? "We haven't heard from your Mac in over 15 minutes. Open Doom Coder on your Mac, or check your network and iCloud sign-in. New data and notifications won't arrive until it reconnects."
