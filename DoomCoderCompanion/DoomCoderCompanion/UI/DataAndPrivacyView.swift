// DataAndPrivacyView.swift — DoomCoder Companion
...
struct DataAndPrivacyView: View {
    ...
    var body: some View {
        ...
        .alert("Data erased", isPresented: $showEraseDone) {
            Button("Close DoomCoder") { exit(0) }
        } message: {
            Text("All local and iCloud data for this device has been removed. Reopen DoomCoder to start fresh.")
        }
    }
