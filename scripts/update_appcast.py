...
Usage:
    python3 scripts/update_appcast.py \
        ...
        --size <bytes> \
        --download-url https://github.com/katipally/Doom-Code/releases/download/v0.2.0/DoomCode-0.2.0.zip
"""
import argparse
...
def update_appcast(version: str, build: str, signature: str, size: int, download_url: str) -> None:
    ...
    release_notes.text = f"https://github.com/katipally/Doom-Code/releases/tag/v{version}"
